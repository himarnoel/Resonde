...
const BecomeVA = () => {
  ...
  return (
    <section ref={sectionRef} className='w-full mx-auto min-h-screen xl:h-[921px] py-[100px] flex justify-center items-center px-[28px] xl:px-0'>
      <div className='w-full xl:w-[1240px] bg-[#002C15] h-full xl:h-[640px] rounded-2xl lg:rounded-[40px] flex flex-col xl:flex-row justify-center items-center gap-[40px] p-[32px] xl:p-0'>
        <div ref={contentRef} className='w-full xl:w-[400px] flex flex-col justify-between items-start gap-[24px]'>
          ...
          <ul ref={listRef} className='w-full xl:w-[368px] flex flex-col justify-center items-start gap-[16px]'>
            <li className='text-white list-disc font-light sofiaProL text-[14px] leading-[22.4px]'>Earn additional income on your own schedule</li>
            <li className='text-white list-disc font-light sofiaProL text-[14px] leading-[22.4px]'>Gain exposure to international clients and expand your professional network</li>
            <li className='text-white list-disc font-light sofiaProL text-[14px] leading-[22.4px]'>Enhance your portfolio with global projects</li>
          </ul>
