...
const items = [
  <div
    key="1"
    className="w-full lg:w-[500px] xl:w-[640px] h-full xl:h-[720px] flex flex-col justify-center items-center"
  >
    <Image
      src={man}
      width={640}
      ...
      <div className="flex flex-col justify-center items-start gap-[24px]">
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <p className="text-[#FAFAFA] leading-[25.6px] text-[1rem] font-light">
            Clients provide details about the specific task or project they need
            help with.
          </p>
        </div>
    ...
    <div className="bg-[#1C1C1C] w-full lg:w-[500px] xl:w-[640px] rounded-bl-[16px] rounded-br-[16px] px-[20px] py-[32px]">
      <div className="flex flex-col justify-center items-start gap-[24px]">
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <p className="text-[#FAFAFA] leading-[25.6px] text-[1rem] font-light">
            Virtual Garden matches you with the best-fit virtual assistant based
            on your needs.
          </p>
        </div>
        <button className="border border-white rounded-full text-white w-[172px] h-[44px] py-[15px] px-[48px] gap-[8px] flex justify-center items-center text-[14px] leading-[14px] font-light">
    ...
    <div className="bg-[#1C1C1C] w-full lg:w-[500px] xl:w-[640px] rounded-bl-[16px] rounded-br-[16px] px-[20px] py-[32px]">
      <div className="flex flex-col justify-center items-start gap-[24px]">
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <p className="text-[#FAFAFA] leading-[25.6px] text-[1rem] font-light">
            Work with your virtual assistant via our platform for efficient task
            management.
          </p>
        </div>
        <button className="border border-white rounded-full text-white w-[172px] h-[44px] py-[15px] px-[48px] gap-[8px] flex justify-center items-center text-[14px] leading-[14px] font-light">
    ...
    <div className="bg-[#1C1C1C] w-full lg:w-[500px] xl:w-[640px] rounded-bl-[16px] rounded-br-[16px] px-[20px] py-[32px]">
      <div className="flex flex-col justify-center items-start gap-[24px]">
        ...
        <div className="flex flex-col gap-[12px]">
          ...
          <p className="text-[#FAFAFA] leading-[25.6px] text-[1rem] font-light">
            Receive results and easily finalize your contract when the project
            is completed.
          </p>
        </div>
        <button className="border border-white rounded-full text-white w-[172px] h-[44px] py-[15px] px-[48px] gap-[8px] flex justify-center items-center text-[14px] leading-[14px] font-light">
