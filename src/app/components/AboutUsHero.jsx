  ...
  return (
    <section className='bg-[#F7F7F7] w-full min-h-screen overflow-hidden'>
        <div className='max-w-[1312.08px] mx-auto flex flex-col justify-center items-center py-[100px]'>
            ...
            <div className='flex justify-end items-center gap-[5px] xl:gap-[16.8px] py-0 my-0 w-full'>
                ...
                <div className='h-[446.88px] flex relative w-full xl:w-[175.56px]'>
                ...
                <div className='h-[64px] xl:h-[446.88px] w-full xl:w-[319.2px] flex relative'>
                    <div className='rounded-[11.57px] xl:rounded-[31.92px] w-[80px] xl:w-[319.2px] bottom-0 h-[236.21px] absolute'>
                ...
                <div className='h-[446.88px] w-full xl:w-[175.56px] flex relative'>
