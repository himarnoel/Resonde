    ...
    <footer className='relative min-h-screen xl:h-[760px] pt-[195px] w-full bg-[#1E3E2A] overflow-hidden'>
        <div className='max-w-[1253px] mx-auto px-3 xl:px-0 flex flex-col justify-between items-center gap-[80px] md:gap-[160px] h-full xl:h-[468px]'>
            <div className='w-full flex flex-col xl:flex-row justify-between items-center gap-[80px] xl:gap-[160px]'>
                ...
                <div className='flex flex-col md:flex-row justify-between items-start gap-[56px] xl:gap-0 xl:items-center w-full xl:w-[600px]'>
                    <ul className='flex flex-col justify-center items-start w-[66px] gap-[30px]'>
                        <li className='text-[#C0C0C0] text-base leading-[16px] font-normal sofiaProL'>About Us</li>
                    ...
                    <ul className='flex flex-col justify-center items-start w-[120px] gap-[30px]'>
                        <li className='text-[#C0C0C0] text-base leading-[16px] font-normal sofiaProL'>Provacy Policy</li>
        ...
        <Image src={obj} alt='Object' className='hidden xl:flex min-h-screen xl:h-[760px] absolute z-[1] top-0'></Image>
        <Image src={resObj} alt='Object' className='flex xl:hidden min-h-screen absolute z-[1] top-0 left-0 right-0 w-full'></Image>
    </footer>
  )
}
