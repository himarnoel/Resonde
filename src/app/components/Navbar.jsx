    ...
    <>
      <nav style={{ backgroundColor: bgColor }} className='px-[24px] lg:px-[80px] py-[20px] lg:py-[20px] h-[80px] lg:h-[88px] sticky top-0 w-full z-50 border-b-[.3px] border-b-[#445c4d]'>
        <div className='max-w-[1280px] mx-auto flex justify-between items-center gap-6'>
          ...
          >
            <div style={{ backgroundColor: color }} className={`duration-300 w-[90%] h-[2px] rounded ${openMenu ? 'rotate-45 translate-x-1 translate-y-1' : 'rotate-0'}`}></div>
            <div style={{ backgroundColor: color }} className={`duration-300 w-[60%] h-[2px] rounded ${openMenu ? '-translate-x-8 opacity-0' : 'translate-x-0 opacity-100'}`}></div>
            <div style={{ backgroundColor: color }} className={`duration-300 h-[2px] rounded ${openMenu ? '-rotate-45 translate-x-1 -translate-y-2 w-[90%]' : 'w-[40%] rotate-0'}`}></div>
          </div>
        </div>
      </nav>
