...
const WhatYouGet = () => {
  return (
    <section className='max-w-[1280px] mx-auto px-3 xl:px-0 py-[100px] xl:pt-[250px] min-h-screen xl:h-[800px] flex flex-col justify-between items-center lg:items-start'>
        <div className='gap-[16px] w-full lg:w-[731px] flex flex-col justify-center items-start'>
        ...
        <div className='max-w-[1280px] mx-auto gap-[40px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-items-center'>
            <div className='w-full lg:w-[400px] border border-[#8B3A33] gap-[24px] py-[40px] px-[32px] rounded-[16px] h-[244px] text-center flex flex-col justify-center items-center'>
