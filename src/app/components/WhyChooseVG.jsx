...
const WhyChooseVG = () => {
  return (
    <section className='bg-white min-h-screen w-full'>
        <div className='bg-[#002C15] relative z-10 min-h-screen w-full rounded-tl-[24px] lg:rounded-tl-[72px] rounded-tr-[24px] lg:rounded-tr-[72px] flex flex-col justify-center items-center py-[100px] px-[24px] lg:px-[80px] gap-[50px] md:gap-[120px]'>
            ...
            <div className='max-w-[1200px] md:max-w-[1280px] mx-auto flex flex-col gap-[40px] lg:gap-[80px]'>

                <div className='bg-[#1E3E2A] border border-[#275037] w-[328px] sm:w-full xl:w-[1280px] h-[440px] md:h-[600px] rounded-[16px] md:rounded-[24px] relative overflow-hidden py-[50px] md:py-[100px] px-[16px] lg:px-[32px] flex flex-col xl:flex-row gap-[16px]'>
                    ...
                    <Image width={898.91} height={546.21} className='hidden xl:flex absolute top-[60px] bottom-[380px] xl:left-[380px] object-cover' src={map} alt='Map'></Image>
                ...
                <div className='flex flex-col lg:flex-row justify-between items-center gap-[40px]'>
                    <div className='w-[328px] sm:w-full xl:w-[620px] h-[440px] md:h-[600px] rounded-[24px] border border-[#275037] bg-[#1E3E2A] relative overflow-hidden px-[30px] py-[50px]'>
                        ...
                        <Image width={840} height={560.08} className='hidden xl:flex absolute bottom-0 top-[231.33px] left-0 right-0 object-cover' src={coin} alt='Coin'></Image>
                ...
                <div className='bg-[#1E3E2A] border border-[#275037] w-[328px] sm:w-full xl:w-[1280px] h-[500px] md:h-[600px] rounded-[24px] relative overflow-hidden py-[50px] lg:py-[100px] px-[32px]'>
