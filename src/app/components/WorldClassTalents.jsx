...
const WorldClassTalents = () => {
  return (
        ...
        <div className='flex flex-col justify-center items-center w-full xl:w-[791px] gap-[8px]'>
            <h1 className='text-[#1E3E2A] font-bold leading-[57.6px] text-[3rem] text-center'>World class Talents at your Fingertips</h1>
            <p className='text-[#9C9797] font-light text-base text-center'>We providing world class talented Virtual Assistants that help you to 10x your productivity</p>
        </div>
