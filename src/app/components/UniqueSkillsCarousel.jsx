...
const items = [
    <div key='1' className='w-[370px] lg:w-[400px] xl:w-[450px] 2xl:w-[600px] h-[600px] xl:pb-[20px] xl:h-[700px] 2xl:h-[750px] flex flex-col justify-between items-start relative'>
        ...
        <div className="px-[18px] py-[32px] flex flex-col justify-between w-full h-full items-start">
            ...
            <div className='z-10 w-full lg:w-[360px] 2xl:w-[550px] rounded-[8px] bg-gradient-to-b from-[white]/[5%] to-[#480455]/[28%] px-[20px] py-[12px] backdrop-blur-md h-[120px]'>
    ...
    <div key='2' className='w-[370px] lg:w-[400px] xl:w-[450px] 2xl:w-[600px] h-[600px] xl:pb-[20px] xl:h-[700px] 2xl:h-[750px] flex flex-col justify-between items-start relative'>
        ...
        <div className="px-[18px] py-[32px] flex flex-col justify-between w-full h-full items-start">
            ...
            <div className='z-10 w-full lg:w-[360px] 2xl:w-[550px] rounded-[8px] bg-gradient-to-b from-[white]/[5%] to-[#5C8CB4]/[28%] px-[20px] py-[12px] backdrop-blur-md h-[120px]'>
    ...
    <div key='3' className='w-[370px] lg:w-[400px] xl:w-[450px] 2xl:w-[600px] h-[600px] xl:pb-[20px] xl:h-[700px] 2xl:h-[750px] flex flex-col justify-between items-start relative'>
        ...
        <div className="px-[18px] py-[32px] flex flex-col justify-between w-full h-full items-start">
            ...
            <div className='z-10 w-full lg:w-[360px] 2xl:w-[550px] rounded-[8px] bg-gradient-to-b from-[white]/[5%] to-[#CE9357]/[28%] px-[20px] py-[12px] backdrop-blur-md h-[120px]'>
    ...
    <div key='4' className='w-[370px] lg:w-[400px] xl:w-[450px] 2xl:w-[600px] h-[600px] xl:pb-[20px] xl:h-[700px] 2xl:h-[750px] flex flex-col justify-between items-start relative'>
        ...
        <div className="px-[18px] py-[32px] flex flex-col justify-between w-full h-full items-start">
            ...
            <div className='z-10 w-full lg:w-[360px] 2xl:w-[550px] rounded-[8px] bg-gradient-to-b from-[white]/[5%] to-[#000000]/[28%] px-[20px] py-[12px] backdrop-blur-md h-[120px]'>
    ...
    <div key='5' className='w-[370px] lg:w-[400px] xl:w-[450px] 2xl:w-[600px] h-[600px] xl:pb-[20px] xl:h-[700px] 2xl:h-[750px] flex flex-col justify-between items-start relative'>
        ...
        <div className="px-[18px] py-[32px] flex flex-col justify-between w-full h-full items-start">
            ...
            <div className='z-10 w-full lg:w-[360px] 2xl:w-[550px] rounded-[8px] bg-gradient-to-b from-[white]/[5%] to-[#7F2315]/[28%] px-[20px] py-[12px] backdrop-blur-md h-[120px]'>
    ...
    <div key='5' className='w-[370px] lg:w-[400px] xl:w-[450px] 2xl:w-[600px] h-[600px] xl:pb-[20px] xl:h-[700px] 2xl:h-[750px] flex flex-col justify-between items-start relative'>
        ...
        <div className="px-[18px] py-[32px] flex flex-col justify-between w-full h-full items-start">
            ...
            <div className='z-10 w-full lg:w-[360px] 2xl:w-[550px] rounded-[8px] bg-gradient-to-b from-[white]/[5%] to-[#767676]/[28%] px-[20px] py-[12px] backdrop-blur-md h-[120px]'>
...
const UniqueSkillsCarousel = () => {
  ...
  return (
    <div className='w-full lg:w-screen z-30 gap-[27px] min-h-[300px] md:h-[600px] xl:h-auto pl-[28px] xl:px-0 flex mt-[3em] xl:mt-0'>
        <AliceCarousel
            items={items}
            autoPlay
